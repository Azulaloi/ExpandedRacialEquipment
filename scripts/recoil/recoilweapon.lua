...
function Weapon:update(dt, fireMode, shiftHeld, moves)
  ...
  for _,ability in pairs(self.abilities) do
    ability:update(dt, fireMode, shiftHeld, moves, self.time)
  end
  ...
  --animator.scaleTransformationGroup("weapon", {0.2, 0.4})
...
function Weapon:recoil()
	self.cameraMove = {(math.random(200) - 100) / 5, (math.random(200) - 100) / 5}
	--self.cameraMove = {(math.random(20) - 10), (math.random(20) - 10)}
end
