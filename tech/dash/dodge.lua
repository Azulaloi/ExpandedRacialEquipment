...
function update(args)
  ...
  if self.dashTimer > 0 then
	...
	--mcontroller.setRotation(-math.pi * 2 * (self.dashTimer))
     mcontroller.controlRotation(5)
    ...
    --while self.dashTimer > 0 do
    --mcontroller.setRotation(100)
	--    mcontroller.controlRotation(-math.pi * 2 * (self.dashTimer))
		--coroutine.yield()
	--end
end
